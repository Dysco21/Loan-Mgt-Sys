...
<div class="container-fluid">
	<div class="col-lg-12">
		<form action="index.php" method="POST" id="manage-borrower" enctype="multipart/form-data">
			...
			<div class="row form-group">
				<div class="col-mb-3">
							...
							<input type="file" class="form-control" name="images" id="images" value="<?php echo isset($tax_id) ? $tax_id : '' ?>">
				</div>
			</div>	
